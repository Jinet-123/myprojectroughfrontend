          ...
          <div>
            ...
            <div className='shadow p-9 mt-8'>
              ...
              <div className='flex mt-7 gap-10'>
                <div className='flex ms-10'>
                  ...
                  <div className='ms-3'>
                    <h1>BHK</h1>
                    <h1 className='text-xl'>{property.bhk}</h1>
                  </div>
            ...
            <div className='shadow p-9 mt-5'>
              ...
              <div className='text-lg mt-5'>
                ...
                <h1 className='flex mb-1'>Plot Area : <h1 className='ms-3'>{property.plotarea}</h1></h1>
                <h1 className='flex mb-1'>Bedrooms : <h1 className='ms-3'>{property.bedrooms}</h1></h1>
                ...
                <h1 className='flex mb-1'>Floors : <h1 className='ms-3'>{property.floors}</h1></h1>

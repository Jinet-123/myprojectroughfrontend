          ...
          <div>
            ...
            <div className='shadow p-9 mt-5'>
              ...
              <div className='text-lg mt-5'>
                <h1 className='flex mb-1'>Total Area : <h1 className='ms-3'>{property.area}</h1></h1>
                <h1 className='flex mb-1'>Ceiling Height : <h1 className='ms-3'>{property.ceilingheight}</h1></h1>
                <h1 className='flex mb-1'>Flooring Type : <h1 className='ms-3'>{property.flooringtype}</h1></h1>
                <h1 className='flex mb-1'>Power Supply : <h1 className='ms-3'>{property.electricityloadcapacity}</h1></h1>
                <h1 className='flex mb-1'>Water Availability : <h1 className='ms-3'>{property.wateravailability}</h1></h1>
                <h1 className='flex mb-1'>Road Access Width : <h1 className='ms-3'>{property.roadwidth}</h1></h1>
                ...
                <h1 className='flex mb-1'>Crane Facility : <h1 className='ms-3'>{property.cranefacility}</h1></h1>
                <h1 className='flex mb-1'>No. of rooms/office : <h1 className='ms-3'>{property.noofrooms}</h1></h1>
                <h1 className='flex mb-1'>Fire safety certificate : <h1 className='ms-3'>{property.firesafety}</h1></h1>
                <h1 className='flex mb-1'>Security Guard : <h1 className='ms-3'>{property.security}</h1></h1>
                <h1 className='flex mb-1'>Price/Rent : <h1 className='ms-3'>{property.rent}</h1></h1>
                <h1 className='flex mb-1'>Negotiable : <h1 className='ms-3'>{property.negotiable}</h1></h1>
